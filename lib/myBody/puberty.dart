...
class Puberty extends StatelessWidget {
  ...
  List<String> factors = [
    ...
    'Starts earlier in slightly overweight girls.',
    'Occurs earlier in girls whose mothers matured early.',
    'Starts earlier in blacks and hispanics than in Asians and whites.'
  ];
  List<String> changes = [
