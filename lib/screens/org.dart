...
class Org extends StatelessWidget {
  ...
  final List<dynamic> orgList = [
    ...
    {
      "url":
          "https://www.hofna.org/#:~:text=HOFNA%20is%20a%20not%2Dfor,%2D%20learn%20more%20%2D",
      "mainText": "Hope for needy association (HOFNA)",
      "location": "Ghana Street Nkwen, Bamenda",
      "subText":
          "HOFNA is a not-for-profit organization with a mission to strengthen the leadership, power, and voices of susceptible women and girls from disadvantaged communities and develop them into self-reliant and socially conscious leaders."
    },
  ];
                      ...
                      child: orgList.length == 0
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return OrgCard(
                                  url: orgList[index]["url"],
                                  mainText: orgList[index]["mainText"],
                                  subText: orgList[index]["subText"],
                                  location: orgList[index]["location"],
                                );
                              })),
                ],
              ),
